...
def ep_add(
    ...
    if output_format == "json":
        _output_json({"id": pipeline_id, "ticker": ep.ticker, "status": ep.status,
...
def ep_fill(
    ...
    if output_format == "json":
        _output_json({"id": pipeline_id, "fill_price": price, "fill_shares": shares,
...
def ep_close(
    ...
    if output_format == "json":
        _output_json({"id": pipeline_id, "exit_price": price, "exit_shares": shares,
...
def ep_update(
    ...
    if output_format == "json":
        _output_json({"id": pipeline_id, "status": status})
    else:
...
def ep_drop(
    ...
    if output_format == "json":
        _output_json({"id": pipeline_id, "status": "invalid"})
    else:
